...
--
-- Host: localhost:3306
-- Generation Time: Jan 01, 2017 at 06:38 AM
...
--
-- Database: `vent_geodata`
--

-- --------------------------------------------------------

--
-- Table structure for table `geodata_th_districts`
--

CREATE TABLE `geodata_th_districts` (
  `district_id` int(11) NOT NULL,
  `district_code` varchar(4) COLLATE utf8_bin NOT NULL,
  `district_name` varchar(150) COLLATE utf8_bin NOT NULL,
  `region_id` int(11) NOT NULL DEFAULT '0',
  `province_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='InnoDB free: 8192 kB; (`GEO_ID`) REFER `crewphra/geography`(';

--
-- Dumping data for table `geodata_th_districts`
--

INSERT INTO `geodata_th_districts` (`district_id`, `district_code`, `district_name`, `region_id`, `province_id`) VALUES
...
--
-- Table structure for table `geodata_th_provinces`
--

CREATE TABLE `geodata_th_provinces` (
...
--
-- Dumping data for table `geodata_th_provinces`
--

INSERT INTO `geodata_th_provinces` (`province_id`, `province_code`, `province_name`, `region_id`) VALUES
...
--
-- Table structure for table `geodata_th_regions`
--

CREATE TABLE `geodata_th_regions` (
...
--
-- Dumping data for table `geodata_th_regions`
--

INSERT INTO `geodata_th_regions` (`region_id`, `region_name`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
--
-- Table structure for table `geodata_th_subdistricts`
--

CREATE TABLE `geodata_th_subdistricts` (
  `subdistrict_id` int(11) NOT NULL,
  `subdistrict_code` varchar(6) COLLATE utf8_bin NOT NULL,
  `subdistrict_name` varchar(150) COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `geodata_th_subdistricts`
--

INSERT INTO `geodata_th_subdistricts` (`subdistrict_id`, `subdistrict_code`, `subdistrict_name`, `district_id`, `province_id`, `region_id`) VALUES
...
--
-- Table structure for table `geodata_th_zipcodes`
--

CREATE TABLE `geodata_th_zipcodes` (
...
--
-- Dumping data for table `geodata_th_zipcodes`
--

INSERT INTO `geodata_th_zipcodes` (`zipcode_id`, `subdistrict_code`, `zipcode`) VALUES
(1, '100101', '10200'),
(2, '100102', '10200'),
(3, '100103', '10200'),
(4, '100104', '10200'),
...
--
-- Indexes for table `geodata_th_districts`
--
ALTER TABLE `geodata_th_districts`
  ADD PRIMARY KEY (`district_id`);

--
-- Indexes for table `geodata_th_provinces`
--
ALTER TABLE `geodata_th_provinces`
  ADD PRIMARY KEY (`province_id`);

--
-- Indexes for table `geodata_th_regions`
--
ALTER TABLE `geodata_th_regions`
  ADD PRIMARY KEY (`region_id`);

--
-- Indexes for table `geodata_th_subdistricts`
--
ALTER TABLE `geodata_th_subdistricts`
  ADD PRIMARY KEY (`subdistrict_id`);

--
-- Indexes for table `geodata_th_zipcodes`
--
ALTER TABLE `geodata_th_zipcodes`
...
--
-- AUTO_INCREMENT for table `geodata_th_districts`
--
ALTER TABLE `geodata_th_districts`
  MODIFY `district_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=999;
--
-- AUTO_INCREMENT for table `geodata_th_provinces`
--
ALTER TABLE `geodata_th_provinces`
  MODIFY `province_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
--
-- AUTO_INCREMENT for table `geodata_th_regions`
--
ALTER TABLE `geodata_th_regions`
  MODIFY `region_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `geodata_th_subdistricts`
--
ALTER TABLE `geodata_th_subdistricts`
  MODIFY `subdistrict_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8861;
--
-- AUTO_INCREMENT for table `geodata_th_zipcodes`
--
ALTER TABLE `geodata_th_zipcodes`
  MODIFY `zipcode_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7456;
